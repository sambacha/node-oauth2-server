...
describe('AuthorizationCodeGrantType integration', () => {
    describe('constructor()', () => {
        it('should throw an error if `model` is missing', () => {
            try {
                new grant_types_1.AuthorizationCodeGrantType({ accessTokenLifetime: 3600 });
        ...
        it('should throw an error if the model does not implement `getAuthorizationCode()`', () => {
            try {
                new grant_types_1.AuthorizationCodeGrantType({
        ...
        it('should throw an error if the model does not implement `revokeAuthorizationCode()`', () => {
            try {
                ...
                new grant_types_1.AuthorizationCodeGrantType({ accessTokenLifetime: 3600, model });
                should.fail('should.fail', '');
            }
            catch (e) {
                e.should.be.an.instanceOf(errors_1.InvalidArgumentError);
    ...
    describe('handle()', () => {
        it('should throw an error if `request` is missing', async () => {
            ...
            const grantType = new grant_types_1.AuthorizationCodeGrantType({
