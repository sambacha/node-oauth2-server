...
describe('AuthenticateHandler integration', () => {
    describe('constructor()', () => {
        it('should throw an error if `options.model` is missing', () => {
            try {
                new handlers_1.AuthenticateHandler();
        ...
        it('should throw an error if the model does not implement `getAccessToken()`', () => {
            try {
                new handlers_1.AuthenticateHandler({ model: {} });
                should.fail('should.fail', '');
            }
            catch (e) {
                e.should.be.an.instanceOf(errors_1.InvalidArgumentError);
        ...
        it('should set the `model`', () => {
            ...
            const grantType = new handlers_1.AuthenticateHandler({ model });
        ...
        it('should set the `scope`', () => {
            ...
            const grantType = new handlers_1.AuthenticateHandler({
                addAcceptedScopesHeader: true,
                addAuthorizedScopesHeader: true,
                model,
                scope: 'foobar',
    ...
    describe('handle()', () => {
        ...
        it('should set the `WWW-Authenticate` header if an unauthorized request error is thrown', () => {
            const model = {
                getAccessToken() {
                    throw new errors_1.UnauthorizedRequestError(undefined, undefined);
                },
            };
        ...
        it('should throw the error if an oauth error is thrown', () => {
            const model = {
                getAccessToken() {
                    throw new errors_1.AccessDeniedError('Cannot request this access token');
                },
            };
            const handler = new handlers_1.AuthenticateHandler({ model });
            const request = new request_1.Request({
    ...
    describe('getTokenFromRequest()', () => {
        ...
        it('should throw an error if `accessToken` is missing', () => {
            ...
            try {
                ...
                e.should.be.an.instanceOf(errors_1.UnauthorizedRequestError);
    ...
    describe('getAccessToken()', () => {
        it('should throw an error if `accessToken` is missing', () => {
            ...
            return handler
                ...
                .catch(e => {
                e.should.be.an.instanceOf(errors_1.InvalidTokenError);
    ...
    describe('verifyScope()', () => {
        it('should throw an error if `scope` is insufficient', () => {
            ...
            return handler
                ...
                .catch(e => {
                e.should.be.an.instanceOf(errors_1.InsufficientScopeError);
