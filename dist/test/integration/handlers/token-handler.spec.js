...
describe('TokenHandler integration', () => {
    describe('constructor()', () => {
        ...
        it('should throw an error if `options.model` is missing', () => {
            try {
                new handlers_1.TokenHandler({ accessTokenLifetime: 120 });
                should.fail('should.fail', '');
            }
            catch (e) {
                e.should.be.an.instanceOf(errors_1.InvalidArgumentError);
        ...
        it('should throw an error if `options.refreshTokenLifetime` is missing', () => {
            try {
                new handlers_1.TokenHandler({ accessTokenLifetime: 120, model: {} });
                should.fail('should.fail', '');
            }
            catch (e) {
                e.should.be.an.instanceOf(errors_1.InvalidArgumentError);
    ...
    describe('handleGrantType()', () => {
        ...
        it('should throw an error if `grant_type` is unsupported', async () => {
            ...
            try {
                ...
                e.should.be.an.instanceOf(errors_1.UnsupportedGrantTypeError);
        ...
        describe('with custom grant_type', () => {
            it('should return a token', () => {
                ...
                const handler = new handlers_1.TokenHandler({
                    ...
                    refreshTokenLifetime: 120,
                    extendedGrantTypes: {
                        'urn:ietf:params:oauth:grant-type:saml2-bearer': grant_types_1.PasswordGrantType,
                    },
                });
                const request = new request_1.Request({
                    body: {
    ...
    describe('updateSuccessResponse()', () => {
        it('should set the `body`', () => {
            ...
            const tokenType = new token_types_1.BearerTokenType('foo', 'bar', 'biz', undefined, undefined);
            const response = new response_1.Response({ body: {}, headers: {} });
    ...
    describe('updateErrorResponse()', () => {
        it('should set the `body`', () => {
            const error = new errors_1.AccessDeniedError('Cannot request a token');
            const model = {
                getClient() { },
                saveToken() { },
            };
