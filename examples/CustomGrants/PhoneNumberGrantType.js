...
var OAuth2Server = require('oauth2-server'),
    AbstractGrantType = OAuth2Server.AbstractGrantType,
    InvalidArgumentError = OAuth2Server.InvalidArgumentError,
    InvalidGrantError = OAuth2Server.InvalidGrantError,
    InvalidRequestError = OAuth2Server.InvalidRequestError;
...
function PhoneNumberGrantType(options) {
    options = options || {};
...
util.inherits(PhoneNumberGrantType, AbstractGrantType);
...
PhoneNumberGrantType.prototype.handle = function (request, client) {
    if (!request) {
...
PhoneNumberGrantType.prototype.getUser = function (request) {
...
PhoneNumberGrantType.prototype.saveToken = function (user, client, scope) {
    var fns = [
...
module.exports = PhoneNumberGrantType;
