...
describe('RevokeHandler integration', () => {
    describe('constructor()', () => {
        ...
        it('should throw an error if the model does not implement `getClient()`', () => {
            try {
                new handlers_1.RevokeHandler({ model: {} });
                should.fail('should.fail', '');
            }
            catch (e) {
                e.should.be.an.instanceOf(errors_1.InvalidArgumentError);
    ...
    describe('handle()', () => {
        ...
        it('should not update the response if an invalid token error is thrown', () => {
            ...
            return handler
                ...
                .then(should.fail)
                .catch(e => {
                e[0].should.be.an.instanceOf(errors_1.InvalidTokenError);
                e[1].should.be.an.instanceOf(errors_1.InvalidTokenError);
                response.body.should.eql({});
    ...
    describe('updateErrorResponse()', () => {
        it('should set the `body`', () => {
            const error = new errors_1.AccessDeniedError('Cannot request a revoke');
            const model = {
                getClient() { },
                revokeToken() { },
                getRefreshToken() { },
...
//# sourceMappingURL=revoke-handler.spec.js.map